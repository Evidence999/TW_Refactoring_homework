...
public class Receipt {
    ...
    public double CalculateGrandTotal(List<Product> products, List<OrderItem> items) {
        ...
        BigDecimal grandTotal = getGrandTotal(products, items, subTotal);
        return setFormat(grandTotal);
    }

    private double setFormat(BigDecimal grandTotal) {
        return grandTotal.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
    }

    private BigDecimal getGrandTotal(List<Product> products, List<OrderItem> items, BigDecimal subTotal) {
